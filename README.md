...
**Literate Verification Suite & Specification Manual for Layer 3d (`FinSc-Dihedron`)**

`FinSc-Dihedron-Wiki` provides formal compile-time macro reflection proofs, QuickCheck property test suites, and literate Markdown specifications for **Layer 3d** of the non-linear discrete multiset physical law ecosystem.
...
```bash
idris2 --build FinSc-Dihedron-Wiki.ipkg
